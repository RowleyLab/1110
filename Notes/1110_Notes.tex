...
\begin{itemize}
	\item Elements are given names and symbols
...
\begin{itemize}
	\item Metals, non-metals, and metalloids
...
\begin{itemize}
	\item Copper wire in silver nitrate solution
\end{itemize}
...
\begin{itemize}
	...
	\item SI units
	\item Metric prefixes and $10^n$ conversions
	\item Derived units
	\item $B_e = \dfrac{h}{8\pi^2\mu R_e^2c}$
\end{itemize}
...
\begin{itemize}
	...
	\item Statistics in many measurements, simple rules for one measurement
...
\begin{itemize}
	...
	\item Dealing with 5 -- me vs book
\end{itemize}
...
\begin{itemize}
	...
	\item My figure on dimensional analysis
	\newpage
	\item Practice Problems
	\begin{itemize}
...
\begin{itemize}
	...
	\item Energy is the capacity to do heat or work. It is in units of J
	...
	\end{itemize}
	\item The energy needed to raise the temperature of a substance is its heat capacity
	\item $1~cal=4.184~J$, based on the heat capacity of water: $4.184\nicefrac{J}{gK}$
	\item $q=mC\Delta T$
\end{itemize}
\section{Density and Specific Gravity}
\begin{itemize}
	\item $density=\dfrac{mass}{volume}$
	\item Density can be affected by temperature changes. Water exhibits anomalous behavior in this respect
	\item Specific gravity relates the density of a substance to the density of water
	\item Practice Problems
	\begin{itemize}
		\item 1.82 -- Scientific notation word problem
...
\begin{itemize}
	...
	\item Atomic mass unit -- \ch{^{12}C} has a mass of \emph{exactly} $12~amu$
...
\begin{itemize}
	...
	\item \ch{^6Li}: $7.59\%$ abundance and $m=6.015122~amu$. \ch{^7Li}: $92.41\%$ abundance and $m=7.016004~amu$
	\item Practice Problems
	\begin{itemize}
...
\begin{itemize}
	...
	\item Different substances have different molecular weights, so $1.0~g$ of \ch{C2H4} has more molecules in it than $1.0~g$ of \ch{HCl}
	...
	\item Find the ratio by comparing the formula masses ($28.0~amu$ vs $36.5~amu$). If I have $1.0~g$ of \ch{C2H4}, how many grams of \ch{HCl} do I need? ($1.3~g$)
...
\begin{itemize}
	...
	\item How many moles is $2.5~g$ of \ch{C2H5Cl}? How many molecules?
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item How many  moles of \ch{NaOH} needed to react with $0.490~g$ \ch{H2SO4}?
...
\begin{itemize}
	...
	With $10.0~g$ of \ch{CO2} and $5.00~g$ of \ch{H2O}, how many grams of sugar are produced?
	\item if $4.8~g$ of sugar are actually recovered, what is the \% recovery?
	
	\item \ch{C6H8O7 + NaHCO3 -> Na3C6H5O7 + H2O + CO2} (unbalanced)
	
	With $1.0~g$ citric acid and $1.0~g$ sodium bicarbonate how many grams of \ch{Na3C6H5O7} are produced?
	
	\item You actually recover $0.56~g$ of citrate. What is the \% yield?
	\item Practice Problems
	\begin{itemize}
...
\begin{itemize}
	...
	\item Pressure can be measured in many different units: $1~atm=760~mmHg=760~torr=14.7~psi=101325~Pa$
\end{itemize}
\section{Boyle's Law}
\begin{itemize}
...
\begin{itemize}
	...
	\item It is convenient to define a standard temperature ($0^\circ C$) and pressure ($1~atm$) or comparing different gas systems
	\item At STP, one mole of an ideal gas occupies a standard molar volume of $22.4~L$	
\end{itemize}
...
\begin{itemize}
	...
	\item Find the pressure when $0.250~mol$ of gas are placed in a $5.20~L$ container at $15.0~^\circ C$ ($1.14~atm$)
	\item How many moles are in a $3.15~L$ helium balloon at $20.0~^\circ C$ and $0.820~atm$? ($0.107~mol$)
\end{itemize}
...
\begin{itemize}
	...
	\item The air is mostly made of \ch{O2} and \ch{N2}. In Cedar City, $P_{\ch{O2}}=0.17~atm$ and $P_{\ch{N2}}=0.64~atm$. What is the total barometric pressure? ($0.81~atm$)
	\item Practice Problems
	\begin{itemize}
...
\begin{itemize}
	...
	\item When the vapor pressure equals the external pressure ($\approx 1~atm$), boiling will begin
...
\begin{itemize}
	...
	\item $7.5~g$ of ice begin at $-6.00~^\circ C$. Find how many $J$ are required to convert this ice into steam at $125~^\circ C$ ($23,000~J$)
...
\begin{itemize}
	...
	\item The primary difference is particle size: Solutions have particles $<2~nm$, colloids have particles $2-500~nm$, and heterogeneous mixtures have particles $>500~nm$
...
\begin{itemize}
	...
	\item Practice Problems
	\begin{itemize}
		\item 10.38 -- Complete dissociation of a strong acid \todo[inline]{change me for a better problem}
...
\begin{itemize}
	...
	\item $1~eq = \dfrac{1~mol}{\#~of~\ch{H3O^+}~or~\ch{OH^-}~ions~produced}$
	\item $1~g-eq = \dfrac{Molar Mass}{\#~of~\ch{H3O^+}~or~\ch{OH^-}~ions~produced}$
