...
\begin{itemize}
	...
	\item 1.66 -- +- error propagation
	\item 1.67 -- */ error propagation
\end{itemize}
...
\begin{itemize}
	...
	\item Atomic mass unit
	      \begin{itemize}
		      ...
		      \item It used to be that \ch{^{12}C} had a mass of \emph{exactly} $12amu$. Technically, the $amu$ is now defined relative to other fundamental constants, but the difference is tiny and inconsequential at the \# of significant figures we use in this class
	      \end{itemize}
